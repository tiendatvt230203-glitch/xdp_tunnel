#!/bin/bash
# SERVER1 (bên gửi) - Đếm packets nhận từ client và gửi qua WAN
...
trap "pkill -P $$; rm -f $TMP1 $TMP2; exit" INT TERM

echo "=== SERVER1 (SENDER) ==="
echo "Local: $LOCAL (từ client)"
echo "WAN:   $WAN (ra network)"
